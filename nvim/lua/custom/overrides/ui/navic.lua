...
local function remove_module_segment_in_vue(input)
...
local function remove_class_name(input)
  return input:gsub("(%w+)%.[%w%-%.]+", "%1")
end

local function print_with_folder(opts)
...
M.get_location = function()
  ...
  location = remove_module_segment_in_vue(location)
  location = remove_class_name(location)
  ...
  if string.len(location) ~= 0 then
    -- return folder_format .. icon .. " %#NavicText#" .. current_file .. "%#NavicSeparator# > " .. location
    return icon .. " %#NavicText#" .. current_file .. "%#NavicSeparator# > " .. location
  else
    return icon .. " %#NavicText#" .. current_file
    -- return folder_format .. icon .. " %#NavicText#" .. current_file
  end
end
